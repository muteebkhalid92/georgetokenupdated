...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var preloaderCoin = document.getElementById("preloader-coin");
  window.addEventListener("load", function () {
    if (preloader && preloaderCoin) {
      gsap.to(preloaderCoin, {rotationY: 360, duration: 1.2, ease: "power2.inOut", onComplete: function() { preloader.style.display = "none"; }});
    }
  });
  /**
   * Slide Up
...
function rememberHomePage() {
  if (isHomePage()) {
    ...
    var file = path.substring(path.lastIndexOf("https://memeworld.pixellyo.com/") + 1) || "index.html";
...
function redirectToRememberedHome(targetId) {
  var currentPath = window.location.pathname.substring(0, window.location.pathname.lastIndexOf("https://memeworld.pixellyo.com/") + 1);
